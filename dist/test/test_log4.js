...
var Log4_1 = __importDefault(require("../utils/Log4"));
// configure('./filename');
var logger = log4js_1.getLogger("[test_log4.ts]");
// logger.level = 'debug';
// logger.level = 'info';
// logger.level = 'all';
...
Log4_1["default"].info("huangshucheng", 1, 2, 3);
Log4_1["default"].error("huangshucheng", 1, 2, 3, "error", null, undefined, "ddd");
//# sourceMappingURL=test_log4.js.map